...
<!-- map -->
<link href="${pageContext.request.contextPath}/manage/css/jqvmap.css" rel='stylesheet' type='text/css' />
<script src="${pageContext.request.contextPath}/manage/js/jquery.vmap.js"></script>
<script src="${pageContext.request.contextPath}/manage/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/manage/js/jquery.vmap.world.js" type="text/javascript"></script>
...
<!-- //map -->
<!----Calender -------->
<link rel="stylesheet" href="${pageContext.request.contextPath}/manage/css/clndr.css" type="text/css" />
<script src="${pageContext.request.contextPath}/manage/js/clndr.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/manage/js/underscore-min.js" type="text/javascript"></script>
<script src= "${pageContext.request.contextPath}/manage/js/moment-2.2.1.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/manage/js/site.js" type="text/javascript"></script>
