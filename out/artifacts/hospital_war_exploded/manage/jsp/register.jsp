...
<body id="login">
  ...
  <form class="form-signin app-cam" action="${pageContext.request.contextPath }/person/add"  onsubmit="return check()">
      <p>输入您的个人信息</p>
      <input type="text" class="form-control1" placeholder="身份证号" name="card" required autofocus="">
      ...
      <div class="registration">
          已有账户.
          <a class="" href="${pageContext.request.contextPath }/manage/jsp/login.jsp">
              登录
          </a>
      </div>
  </form>
