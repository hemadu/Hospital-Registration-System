			...
			<div class="xs">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="horizontal-form">
						<form id="userForm" class="form-horizontal" name="userForm" method="post" action="${pageContext.request.contextPath }/
						<c:if test="${roles==0}">
						doctor
						</c:if>
						<c:if test="${roles!=0}">
						...
						/updateexe">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<c:if test="${roles==0}">
										<input type="text" class="form-control1" id="focusedinput"  name="num"  value="${userSession.num}">
									</c:if>
									<c:if test="${roles!=0}">
										<input type="text" readonly="readonly" class="form-control1" id="focusedinput"  name="card"  value="${userSession.card}">
									</c:if>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control1" name="age" value="${userSession.age}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input readonly="readonly" type="text" class="form-control1" id="disabledinput" name="username" value="${userSession.username}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input  type="hidden" name="sid" value="${userSession.sid}">
									<input readonly="readonly"  type="text" class="form-control1"  value="${doctor.sector.name}">
								</div>
							</div>
							</c:if>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<c:if test="${roles==0}">
										<input  type="hidden" name="type" value="${userSession.type}">
										<input   type="text" class="form-control1" readonly="readonly" value="${userSession.type==1?"专家":"医生"}"  >
									</c:if>
									<c:if test="${roles!=0}">
										<input  type="hidden" name="role" value="${userSession.role}">
										<input  type="text" class="form-control1" readonly="readonly" value="${userSession.role==1?"管理员":"普通用户"}" >
									</c:if>
