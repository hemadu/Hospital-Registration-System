			...
			<div class="xs">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="horizontal-form">
						<form id="userForm" class="form-horizontal" name="userForm" method="post" action="${pageContext.request.contextPath }/doctor/addexe" onsubmit="return check()">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
										<input required  type="text" class="form-control1" id="focusedinput"  name="num">
								</div>
							</div>
							<div class="form-group">
								<label for="focusedinput" class="col-sm-2 control-label">姓名</label>
								<div class="col-sm-8">
									<input  required type="text" class="form-control1" name="name" >
								</div>
							</div>
							<div class="form-group">
								<label for="focusedinput" class="col-sm-2 control-label">年龄</label>
								<div class="col-sm-8">
									<input required  type="text" class="form-control1" name="age">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input  required type="text" class="form-control1" name="phone" >
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input  required  type="text" class="form-control1" id="disabledinput" name="username" >
								</div>
							</div>
							<div class="form-group">
								<label for="disabledinput" class="col-sm-2 control-label">密码</label>
								<div class="col-sm-8">
									<input required type="password" id="newpass1" name="password" class="form-control1">
								</div>
							</div>
							<div class="form-group">
								<label for="disabledinput" class="col-sm-2 control-label">确认密码</label>
								<div class="col-sm-8">
									<input required type="password"  id="newpass2"  type="password"class="form-control1">
								</div>
							</div>
